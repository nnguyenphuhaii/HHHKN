...
namespace HHHKN.Areas.Admin.Controllers
{
    public class TopicController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,UserId,Name,Phone,Email,Note,Created_At,Updated_By,Update_At,Status")] Topic topic)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserId,Name,Phone,Email,Note,Created_At,Updated_By,Update_At,Status")] Topic topic)
        {
            if (ModelState.IsValid)
            {
